...
export const Onboarding = ({ onComplete }) => {
  ...
  return (
    <div className="clay-card" style={{ maxWidth: '800px', width: '100%', margin: '0 auto', padding: '40px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
            {LOCATIONS_LIST.map(loc => (
              <Button 
                ...
                className={formData.preferred_environment === loc.id ? 'clay-button-selected' : ''}
            ...
            {EQUIPMENT_LIST.map(eq => (
              <div 
                ...
                style={{ 
                  ...
                  textAlign: 'center', 
                  cursor: 'pointer',
                  boxShadow: formData.equipment.includes(eq.id) ? 'var(--clay-shadow-active)' : 'var(--clay-shadow)',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px' }}>
            {GOALS_LIST.map(goal => (
              <Button 
                ...
                className={formData.goals === goal.id ? 'clay-button-selected' : ''}
